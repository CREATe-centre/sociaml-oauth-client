...
(* OASIS_START *)
(* DO NOT EDIT (digest: 21b0922f633aa519b55c3d4ef3ea6602) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage =
            Some "https://github.com/dominicjprice/sociaml-oauth-client";
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Result"; "S"; "Util"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "sociaml_oauth_client";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "sociaml_oauth_client_posix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "sociaml_oauth_client"
                        ];
                      bs_build_tools =
                        [
                           ExternalTool "ocamlbuild";
                   ...
                   {
                      lib_modules = ["Sociaml_oauth_client_posix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "sociaml_oauth_client";
                      lib_findlib_name = Some "posix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "sociaml_oauth_client_v1_0a";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/sociaml-oauth-client";
                      doc_title = "sociaml-oauth-client Reference";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/dominicjprice/sociaml-oauth-client.git";
                      src_repo_browser =
                        Some
                          "https://github.com/dominicjprice/sociaml-oauth-client";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\001tßð\028Ïé§§¹Æþ\023¯\148ß";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
