...
(* OASIS_START *)
(* DO NOT EDIT (digest: 20a68dd329d0f13ec3ccd51a98dd9306) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "A basic client library for the OAuth protocol. Supports versions 1.0a and 2.0."
              ];
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\166\025R\243\165\157\1362\236,{\191\141Yt3";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
