...
(* OASIS_START *)
(* DO NOT EDIT (digest: c5a4215db05773fa7dd37bf4b2f51b17) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/dominicjprice/oauth-client";
          synopsis = "OAuth Client Library for Ocaml";
          description =
            Some
              [
                 OASISText.Para
                   "A very basic OAuth client library for OCaml.  Currently supports Version 1.0a of the OAuth protocol and has been tested against the Twitter and Tumblr APIs."
              ];
          categories = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "oauth-client";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "oauth_client_posix";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Oauth_client_posix"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "oauth_client";
                      lib_findlib_name = Some "posix";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "oauth_client_v1_0a";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Client"; "Signature"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "oauth_client";
                      lib_findlib_name = Some "v1_0a";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install_dir = "$htmldir/oauth-client";
                      doc_title = "OAuth-Client API Reference";
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/dominicjprice/oauth-client.git";
                      src_repo_browser =
                        Some "https://github.com/dominicjprice/oauth-client";
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "F\212\225\022+\212=\134\239!'\220\129\212\207\167";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
